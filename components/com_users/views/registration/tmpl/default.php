...
<div id="system" class="contentwrapper">
	...
	<form id="register" class="uk-form uk-form-stacked form-validate"
			...
			<div class="uk-width-medium-1-2">
				<fieldset>
					...
					<div class="uk-form-row">
						<?php echo $this->form->getLabel('geslacht', 'profile'); ?>
						<div class="uk-form-controls"><?php echo $this->form->getInput('geslacht', 'profile'); ?></div>
					</div>
					<div class="uk-form-row">
						<?php echo $this->form->getLabel('voornaam', 'profile'); ?>
						<div class="uk-form-controls"><?php echo $this->form->getInput('voornaam', 'profile'); ?></div>
					</div>
					<div class="uk-form-row">
						<?php echo $this->form->getLabel('achternaam', 'profile'); ?>
						<div
					...
					<div class="uk-form-row bix-postcodefill-form">
						<label class="uk-form-label"><?php echo JText::_('COM_BIXPRINTSHOP_REGISTRATION_ADRES'); ?>
							*</label>
						<?php
						$bixUser = BixTools::getFrontUser();
						$userHelper = BixTools::userhelper($bixUser);
						echo $userHelper->renderAdresForm(array('control' => 'jform[adres]', 'context' => 'com_bixprintshop.shortadresform'));
						//pr($bixUser);
						?>
				...
				<div class="uk-panel uk-panel-box">
					<fieldset>
						...
						<div class="uk-form-row">
							...
							<div class="uk-form-controls"><?php echo $this->form->getInput('username'); ?></div>
						</div>
						<div class="uk-form-row">
							<?php echo $this->form->getLabel('password1'); ?>
							<div class="uk-form-controls"><?php echo $this->form->getInput('password1'); ?></div>
						</div>
						<div class="uk-form-row">
							<?php echo $this->form->getLabel('password2'); ?>
							<div class="uk-form-controls"><?php echo $this->form->getInput('password2'); ?></div>
						</div>
						<div class="uk-form-row">
							<?php echo $this->form->getLabel('tos', 'profile'); ?>
							<div class="uk-form-controls"><?php echo $this->form->getInput('tos', 'profile'); ?></div>
						</div>
					</fieldset>
				</div>
			</div>
		...
		<div class="uk-grid">
			...
			<div class="uk-width-medium-1-2">
				<button type="submit" class="uk-button uk-button-primary uk-button-large uk-width-1-1 validate">
					<i class="uk-icon-user uk-margin-right"></i><?php echo JText::_('COM_BIXPRINTSHOP_REGISTRATION_REGISTER'); ?>
				</button>
			</div>
		</div>
